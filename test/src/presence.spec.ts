...
describe('presence checks', function () {
  ...
  describe('not is.empty', function () {
  ...
  describe('every is.empty', function () {
    it('should return true if given array, object and string are empty', function () {
      expect([[], '', {}].every(is.empty)).to.be.true;
    });

    it('should return false if any given array element is not empty', function () {
      expect([['not', 'empty'], {}, '', undefined].every(is.empty)).to.be.false;
    });
  });

  describe('some is.empty', function () {
    it('should return true if any of the given array, object and string are empty', function () {
      expect([[{ not: 'empty' }], '', {}].some(is.empty)).to.be.true;
    });

    it('should return true if any given array elements is empty', function () {
  ...
  describe('not is.existy', function () {
  ...
  describe('every is.existy', function () {
  ...
  describe('some is.existy', function () {
    it('should return true if any given values are existy', function () {
      expect([undefined, {}, '', true].some(is.existy)).to.be.true;
    });

    it('should return false if given all values are not existy', function () {
  ...
  describe('not is.truthy', function () {
  ...
  describe('every is.truthy', function () {
  ...
  describe('some is.truthy', function () {
    it('should return true if any given values is truthy', function () {
      expect(['truthy', [], false].some(is.truthy)).to.be.true;
    });

    it('should return false if all given values are not truthy', function () {
  ...
  describe('not is.falsy', function () {
    it('should return true if given value is truthy', function () {
  ...
  describe('every is.falsy', function () {
  ...
  describe('some is.falsy', function () {
    it('should return true if any given values are falsy', function () {
      expect([undefined, true, 34].some(is.falsy)).to.be.true;
    });

    it('should return false if every given value is not falsy', function () {
  ...
  describe('not is.space', function () {
  ...
  describe('every is.space', function () {
  ...
  describe('some is.space', function () {
    it('should return true if any given values are space', function () {
      expect([' ', 'a', 'foo'].some(is.space)).to.be.true;
    });

    it('should return false if all given values are note space', function () {
