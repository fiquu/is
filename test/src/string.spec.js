describe('string checks', function () {
  describe('is.include', function () {
    it('returns true if given string contains substring', function () {
      expect(is.include('test.com', 't.com')).to.be.true;
    });

    it('returns false if given string does not contain substring', function () {
      expect(is.include('test.com', 'nope')).to.be.false;
    });
  });

  describe('not is.include', function () {
    it('returns false if given string contains substring', function () {
  ...
  describe('not is.upperCase', function () {
  ...
  describe('every is.upperCase', function () {
  ...
  describe('some is.upperCase', function () {
  ...
  describe('not is.lowerCase', function () {
  ...
  describe('every is.lowerCase', function () {
  ...
  describe('some is.lowerCase', function () {
  ...
  describe('is.startWith', function () {
    it('returns true if given string starts with substring', function () {
      expect(is.startWith('testing', 'te')).to.be.true;
    });

    it('returns false if given string does not start with substring', function () {
      expect(is.startWith('not testing', 'st')).to.be.false;
    });
  });

  describe('not is.startWith', function () {
    it('returns false if given string starts with substring', function () {
      expect(is.not.startWith('testing', 'te')).to.be.false;
    });

    it('returns true if given string does not start with substring', function () {
      expect(is.not.startWith('testing', 'st')).to.be.true;
    });
  });

  describe('is.endWith', function () {
    it('returns true if given string ends with substring', function () {
      expect(is.endWith('testing', 'ng')).to.be.true;
    });

    it('returns false if given string does not end with substring', function () {
  ...
  describe('not is.endWith', function () {
    it('returns false if given string ends with substring', function () {
      expect(is.not.endWith('testing', 'ng')).to.be.false;
    });

    it('returns true if given string does not end with substring', function () {
  ...
  describe('not is.capitalized', function () {
  ...
  describe('every is.capitalized', function () {
  ...
  describe('some is.capitalized', function () {
  ...
  describe('not is.palindrome', function () {
  ...
  describe('every is.palindrome', function () {
  ...
  describe('some is.palindrome', function () {
